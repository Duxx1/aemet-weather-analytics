# Análisis de datos climatológicos con AEMET

Este proyecto tiene como objetivo la extracción, procesamiento y análisis de datos climatológicos utilizando la API de OpenData de AEMET. Se centra principalmente en la recopilación de información histórica de estaciones meteorológicas, con especial atención a la provincia de Badajoz dentro de la región de Extremadura.
